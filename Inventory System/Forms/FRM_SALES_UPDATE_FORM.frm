...
Begin VB.Form FRM_SALES_UPDATE_FORM 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Modify Sales Entry ..."
   ClientHeight    =   6915
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9945
   ...
   Begin VB.Frame Frame1 
      ...
      Begin LVbuttons.LaVolpeButton LaVolpeButton1 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_SALES_UPDATE_FORM.frx":0000
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton LaVolpeButton2 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_SALES_UPDATE_FORM.frx":001C
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
   ...
   Begin VB.Frame Frame2 
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_SALES_UPDATE_FORM.frx":0038
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_SALES_UPDATE_FORM.frx":0054
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_SALES_UPDATE_FORM.frx":0070
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_SALES_UPDATE_FORM.frx":008C
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_SALES_UPDATE_FORM.frx":00A8
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton cmd 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "FRM_SALES_UPDATE_FORM.frx":00C4
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin VB.Label issues 
      BackStyle       =   0  'Transparent
      Caption         =   "Please Be Sure while updating Sales entry in to Sales Master."
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image1 
      Height          =   840
      Left            =   0
      Picture         =   "FRM_SALES_UPDATE_FORM.frx":00E0
      Stretch         =   -1  'True
      Top             =   0
      Width           =   10080
   End
End
Attribute VB_Name = "FRM_SALES_UPDATE_FORM"
