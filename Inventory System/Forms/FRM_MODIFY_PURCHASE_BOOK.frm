...
Begin VB.Form FRM_MODIFY_PURCHASE_BOOK 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Modify Purchase Book Entry ..."
   ClientHeight    =   6990
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9315
   ControlBox      =   0   'False
   Icon            =   "FRM_MODIFY_PURCHASE_BOOK.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin LVbuttons.LaVolpeButton LaVolpeButton3 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_MODIFY_PURCHASE_BOOK.frx":0E42
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Combo2 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   360
         ItemData        =   "FRM_MODIFY_PURCHASE_BOOK.frx":0E5E
         Left            =   1320
         List            =   "FRM_MODIFY_PURCHASE_BOOK.frx":0E60
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   360
         ItemData        =   "FRM_MODIFY_PURCHASE_BOOK.frx":0E62
         Left            =   1320
         List            =   "FRM_MODIFY_PURCHASE_BOOK.frx":0E64
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   600
         Width           =   3135
      ...
      Begin LVbuttons.LaVolpeButton LaVolpeButton1 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_MODIFY_PURCHASE_BOOK.frx":0E66
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton LaVolpeButton2 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_MODIFY_PURCHASE_BOOK.frx":0E82
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_MODIFY_PURCHASE_BOOK.frx":0E9E
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_MODIFY_PURCHASE_BOOK.frx":0EBA
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_MODIFY_PURCHASE_BOOK.frx":0ED6
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_MODIFY_PURCHASE_BOOK.frx":0EF2
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmd_op 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "FRM_MODIFY_PURCHASE_BOOK.frx":0F0E
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "(None)"
         ICONAlign       =   0
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "FRM_MODIFY_PURCHASE_BOOK.frx":0F2A
      Height          =   1455
      Left            =   240
      TabIndex        =   18
      Top             =   4920
