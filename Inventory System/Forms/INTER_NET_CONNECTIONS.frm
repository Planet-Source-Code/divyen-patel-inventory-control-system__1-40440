...
Begin VB.Form INTER_NET_CONNECTIONS 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Internet Connection Sales Entry ..."
   ClientHeight    =   6285
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8595
   Icon            =   "INTER_NET_CONNECTIONS.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.ComboBox Combo2 
      ...
      ForeColor       =   &H00FF0000&
      Height          =   315
      ItemData        =   "INTER_NET_CONNECTIONS.frx":0E42
      Left            =   4320
      List            =   "INTER_NET_CONNECTIONS.frx":0E44
      Style           =   2  'Dropdown List
      TabIndex        =   4
      Top             =   1560
      Width           =   3855
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton3 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "INTER_NET_CONNECTIONS.frx":0E46
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton1 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "INTER_NET_CONNECTIONS.frx":0E62
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton2 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "INTER_NET_CONNECTIONS.frx":0E7E
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin VB.Image Image1 
      Height          =   2280
      Left            =   0
      Picture         =   "INTER_NET_CONNECTIONS.frx":0E9A
      Top             =   0
      Width           =   1785
   End
   ...
   End
End
Attribute VB_Name = "INTER_NET_CONNECTIONS"
